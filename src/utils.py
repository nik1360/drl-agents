...
def exploration_noise_from_args(args, n_actions, n_obs, action_ub):
    if args.noise_type == "OU":
        ...
        perturbed_actor_params = NetworkParams(n_inputs=n_obs, n_outputs=n_actions, n_actions=n_actions,
            layer1_dims=args.actor_l1_dim, layer2_dims=args.actor_l2_dim, apply_input_norm=args.input_norm,
            apply_layer_norm=args.layer_norm, learning_rate=args.critic_lr, action_ub=action_ub_tens)
